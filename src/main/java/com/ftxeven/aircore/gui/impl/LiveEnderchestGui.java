...
public final class LiveEnderchestGui implements GuiRenderer.DynamicRenderer {

    public static final String ROLE = "inventory-enderchest";
    public static final String ATTR_HANDLE = "enderchest-handle";
    public static final String ATTR_INITIAL_CONTENTS = "enderchest-initial-contents";
    private static final String ATTR_CONTAINER = "enderchest-container";

    private final PlayerService players;
    private final LayoutGuiRegistry layouts;
    private final Logger logger;

    public LiveEnderchestGui(PlayerService players, LayoutGuiRegistry layouts, Logger logger) {
    ...
    public void render(Player viewer, GuiSession session) {
        ...
        container = new RemoteContainerRenderer(handle, logger, true, List.of(
