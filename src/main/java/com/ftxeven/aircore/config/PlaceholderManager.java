...
import com.ftxeven.aircore.core.service.PlaceholderService;
...
public final class PlaceholderManager {
    ...
    public String resolve(OfflinePlayer player, String key, Map<String, String> context) {
        PlaceholderEntry entry = registry.get(key.toLowerCase());
        if (entry == null) return null;

        Map<String, String> ctx = (context != null) ? context : Collections.emptyMap();
        return service.resolve(player, entry, ctx, key);
    }
}