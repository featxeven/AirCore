package com.ftxeven.aircore.core.modules.kit;
...
public final class KitService {
    ...
    public void grantFirstJoinKit(Player player) {
        ...
        plugin.scheduler().runAsync(() -> {
            ...
            plugin.scheduler().runEntityTask(player, () -> player.getInventory().addItem(
    ...
    public boolean isAvailable(UUID uuid, String kitName) {
        ...
        if (config.getBoolean("kits." + kitName + ".one-time", false) && data.oneTimeClaimed()) {
            return false;
        }
